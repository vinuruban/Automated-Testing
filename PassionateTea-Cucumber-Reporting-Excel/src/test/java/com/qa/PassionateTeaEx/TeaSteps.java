...
import com.qa.PassionateTeaEx.ExcelUtils;
import com.qa.PassionateTeaEx.Constants;
import com.qa.PassionateTeaEx.TeaCheckOutPage;
import com.qa.PassionateTeaEx.TeaHomePage;
import com.qa.PassionateTeaEx.TeaMenuPage;
...
public class TeaSteps {
	...
	TeaCheckOutPage checkOutPage = PageFactory.initElements(driver, TeaCheckOutPage.class);
		...
		if(checkText.equals(txt)) {
			...
			ExcelUtils.setCellData("Pass", Constants.count, 3);
		}
		else { 
